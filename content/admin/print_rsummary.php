                            ...
                            <table class="table table-striped table-bordered table-hover" style="width: 100%; margin-bottom: 20px;">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th colspan="2"><center>Price Change</center></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pla" style="padding: 4px;"><?php echo "(".date("M/d/Y",strtotime($row_item_detail['gy_old_price_date'])).") <b>".number_format($row_item_detail['gy_product_old_price'],2)." - <span style='color: $my_price_color;'>".number_format($row_item_detail['gy_product_price_cap'],2)."</span></b>"; ?></td>
