<?php
    ...
    if ($search_text == "mrcoffeex_only_space") {
        ...
        $my_project_header_title = "Stock-Transfer Report Search: <span style='color: blue;'>".$search_text."</span>";

        $my_query=$link->query("Select * From `gy_stock_transfer` Where `gy_transfer_code` LIKE '%$search_text%' Order By `gy_transfer_date` ASC");
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Stock-Transfer Data Table <b><?php echo 0+$count_results; ?></b> result(s) <a href="print_tsummary?cd=<?php echo $search_text; ?>&mode=entry_search" onclick="window.open(this.href, 'mywin',
