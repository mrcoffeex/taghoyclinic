<?php
    ...
    $my_project_header_title = "Items Sold Search: " . proper_date($datef) . " - " . proper_date($datet);
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    <?php
                                        $getSold=selectItemsSold($datef, $datet);
                                    ...
                                    ?>
                                        ...
                                        <tr class="success">
                                            ...
                                            <td class="text-center text-bold"><?= getItemSoldQty($datef, $datet, $sold['item_sold']) . " " . $sold['gy_product_unit'] ?></td>
                                        </tr>
