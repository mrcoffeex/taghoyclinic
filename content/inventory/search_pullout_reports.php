                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Pull-Out Data Table <span style="color: green;">FOR USE</span> / <span style="color: red;">DAMAGE ITEM</span> / <span style="color: red;">EXPIRED</span> / <span style="color: #009fb1;">SOLD</span> <b><?php echo 0+$count_results; ?></b> result(s) <a href="print_psummary?datef=<?php echo $datef; ?>&datet=<?php echo $datet; ?>&mode=date_search" onclick="window.open(this.href, 'mywin',
